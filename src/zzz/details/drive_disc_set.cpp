...
namespace zzz::details {
    ...
    bool DriveDiscSetBuilder::is_built() const {
        return _is_set.id && _is_set.name && _is_set.p2 && _is_set.p4;
    }
    ...
    // TODO
    toml::value DriveDiscSetAdaptor::to_t1(const DriveDiscSet& data) {
        return {};
    }
    DriveDiscSet DriveDiscSetAdaptor::to_t2(const toml::value& data) {
        ...
        builder.set_p2(global::stats_grid_adaptor.to_t2(set_bonuses.at("p2")));
        builder.set_p4(global::stats_grid_adaptor.to_t2(set_bonuses.at("p4")));
